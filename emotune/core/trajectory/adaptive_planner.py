...
class AdaptivePlanner(TrajectoryPlanner):
    ...
    def adapt_trajectory(self, emotion_trajectory: list, current_emotion: dict) -> bool:
    ...
    def _select_adaptive_trajectory(self, valence: float, arousal: float, current_type: TrajectoryType) -> TrajectoryType:
    ...
    def _get_adaptive_target(self, trajectory_type: TrajectoryType, current_emotion: dict) -> dict:
    ...
    def _adjust_trajectory_parameters(self, current_emotion: dict) -> bool:
        ...
        try:
            ...
            time_extension = min(120.0, self.duration * 0.3)
    ...
    def update_trajectory_success_rate(self, trajectory_type: TrajectoryType, success: bool):
    ...
    def get_adaptation_statistics(self) -> dict:
        """Return statistics about adaptation attempts"""
        return {
            'adaptation_history': self.adaptation_history,
            'success_rates': self.trajectory_success_rates
        }
